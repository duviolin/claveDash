  ...
  return (
    <div className="relative inline-block" ref={popoverRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span
            className="absolute -top-0.5 -right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-error px-1 text-[10px] font-bold text-on-error"
      ...
      {isOpen && (
        <div className="absolute right-0 top-full z-50 mt-2 w-[min(20rem,calc(100vw-1rem))] rounded-xl border border-border bg-surface shadow-2xl overflow-hidden">
