...
const CHILD_NAV: Record<string, { label: string; buildUrl: (identifier: string) => string }> = {
  ...
  trackSceneTemplates: { label: 'Cenas', buildUrl: (slug) => `/templates/tracks?projectSlug=${slug}` },
  projects: { label: 'Projetos', buildUrl: () => `/instances/projects` },
  pressQuizTemplates: { label: 'Coletivas de imprensa', buildUrl: (slug) => `/templates/press-quizzes?projectSlug=${slug}` },
  studyTrackTemplates: { label: 'Trilhas de estudo', buildUrl: (slug) => `/templates/study-tracks?projectSlug=${slug}` },
  trackMaterialTemplates: { label: 'Materiais', buildUrl: (slug) => `/templates/materials?projectSlug=${slug}` },
